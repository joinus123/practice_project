        ...
        <section id="configuration">
          <div class="row">
                      <div class="col-lg-6 offset-lg-3 col-12">
                        ...
                        <form action="{{route('update-service',$editservice['id'])}}" method="post"  enctype="multipart/form-data">
                            @csrf
                           <div class="row">

                             <div class="col-12 form-group">
                               <label for="">Service Heading </label>
                               <input  type="text" contenteditable="true" spellcheck="true" value="{{$editservice->service_heading}}"  name="service_heading" class="form-control" placeholder="Full Name">
                             </div>
                             <div class="col-12 form-group">
                               <label for="">Icon Heading</label>
                               <input type="text" contenteditable="true" spellcheck="true"  value="{{$editservice->icon_heading}}" name="icon_heading" class="form-control" placeholder="Last Name">
                             </div>

                              <div class="col-12 form-group">
                               <label> Description</label>
                               <textarea class="editor form-control" rows="3"   id="section_one_box_two_text"  name="description" required>{{$editservice->description }}
                                 </textarea>
                            </div>

                             <div class="col-12 form-group">
                               <div class="attached"> <img src="{{asset('images/'.$editservice->icon_image)}}" style="width:80px" alt="">
