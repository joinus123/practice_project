        ...
        <section id="configuration">
          <div class="row">
                      <div class="col-lg-6 offset-lg-3 col-12">
                        ...
                        <form action="{{route('store-testinomial')}}" method="post"  enctype="multipart/form-data">
                            @csrf
                           <div class="row">

                             <div class="col-12 form-group">
                               <label for="">Clinet Name</label>
                               <input  type="text" contenteditable="true" spellcheck="true" value=""  name="client_name" class="form-control" placeholder="Full Name">
                             </div>
